...
# Datasets
parser.add_argument('-train', '--trainroot', default='/home/ma-user/work/new/train1.txt', type=str) #new_shu_label
parser.add_argument('-val', '--valroot', default='/home/ma-user/work/new/val1.txt', type=str)
...
parser.add_argument('--num-classes', default=54, type=int, metavar='N',
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='/home/ma-user/work/model_snap', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoint)')
parser.add_argument('--resume', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnext101_32x16d_inference',
                    choices=model_names,
