...
'''
__all__ = ['resnext101_32x8d_wsl', 'resnext101_32x16d_wsl', 'resnext101_32x32d_wsl', 'resnext101_32x48d_wsl', 'resnext101_32x16d_inference']
...
def _resnext(arch, block, layers, pretrained, progress, **kwargs):
    model = ResNet(block, layers, **kwargs)
    if pretrained:
        state_dict = torch.load('/home/ma-user/work/cache/ig_resnext101_32x16-c6f796b0.pth')
        print('load pretrained model')
        #state_dict = load_state_dict_from_url(model_urls[arch], progress=progress, model_dir = '/home/ma-user/work/cache')#/home/ma-user/work/cache
...
def resnext101_32x16d_inference(progress=True, **kwargs):
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 16
    return _resnext('resnext101_32x16d_inference', Bottleneck, [3, 4, 23, 3],False,
                    progress, **kwargs)
