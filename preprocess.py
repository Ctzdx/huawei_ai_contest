...
data_path = base_path + 'official_data'
...
folds = StratifiedKFold(n_splits=50, shuffle=True, random_state=2019)
...
with open(base_path + 'official/train1.txt', 'w') as f1:
    for item in train_data:
        f1.write(item + '\n')

with open(base_path + 'official/val1.txt', 'w') as f2:
